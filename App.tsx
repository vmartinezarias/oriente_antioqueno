...
function App() {
  ...
  return (
    <div className="flex flex-col h-screen w-screen overflow-hidden bg-slate-50">
      ...
      {/* Header */}
      <header className="bg-white z-50 shadow-sm border-b border-gray-200 px-6 py-3 flex items-center justify-between h-16 shrink-0">
        <div className="flex items-center gap-4">
           ...
           />
           <div>
             <h1 className="text-lg font-bold text-slate-800 leading-none">Oriente Antioqueño</h1>
             <span className="text-xs text-slate-500 uppercase tracking-wider">Monitor de Sectores Estratégicos</span>
           </div>
        </div>
